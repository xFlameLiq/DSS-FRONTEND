...
import { ApiAuthImpl, CreateNewProductImpl, CreateNewUserImpl, PasswordRecoveryImpl, UpdatePasswordImpl } from "@config/ServicesContainer";
...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      {
        path: "crud",
        element: <Crud CreateNewProductService={CreateNewProductImpl}/>,
        errorElement: "",
      }
